...
class rtmaps_python(BaseComponent):
    ...
    def Core(self):
        # virage = self.inputs["Virage"].ioelt.data # new
        vitess = self.inputs["vitesse"].ioelt.data
        #Radius of the purepursuit method

        radius = int(vitess / 4) + 3  # TODO
